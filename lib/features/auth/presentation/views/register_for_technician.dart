...
import 'package:servicex/features/auth/presentation/viewmodels/register_viewmodel/register_cubit.dart';
...
class RegisterForTechnicianbView extends StatefulWidget {
  const RegisterForTechnicianbView({super.key});

  @override
  State<RegisterForTechnicianbView> createState() =>
      _RegisterForCustomerViewState();
}

class _RegisterForCustomerViewState extends State<RegisterForTechnicianbView> {
  ...
  final TextEditingController paybythehourController = TextEditingController();
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CustomTextFormFieldd(
                      ...
                      controller: paybythehourController,
                    ),
                            ...
                            onPressed: () async {
                              if (_formKey.currentState!.validate()) {
                                ...
                                FormData formData = FormData.fromMap({
                                  ...
                                  'ServiceId': CacheService.getData(
                                    key: CacheConstants.technichianService,
                                  ),
                                  'PayByHour': paybythehourController.text,
